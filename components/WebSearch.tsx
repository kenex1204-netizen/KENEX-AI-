...
const WebSearch: React.FC = () => {
  ...
  const LOCAL_STORAGE_KEY = 'webSearchHistory';
    ...
    <div className="flex flex-col h-full">
      <div className="flex flex-col sm:flex-row gap-2 mb-4">
        <input
          ...
          placeholder="Ask anything in English or Spanish..."
        ...
        <div className="md:col-span-4 bg-gray-800/50 p-4 rounded-lg flex flex-col">
          ...
          <ul className="flex-grow overflow-y-auto space-y-1 -mr-2 pr-2">
            {history.length > 0 ? history.map(item => (
              ...
              <li className="flex items-center justify-center h-full text-gray-500 text-center text-sm">No search history.</li>
            )}
          </ul>
        </div>
